...
from adminapp.views import UsersListView, UserCreateView, UserUpdateView, UserDeleteView, CategoriesListView, CategoryUpdateView, CategoryDeleteView, CategoryCreateView
